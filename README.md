...
| **Chronoscope Core**: приём, нормализация, хранение, API | **готово**, 297 тестов |
...
```powershell
cd core
uv run pytest        # 297 тестов: домен, хранилище, нормализатор, контракт, правила слоёв, CLI, страница, скрипты, интеграция
