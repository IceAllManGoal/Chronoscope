...
| Экземпляр процесса — 0.0.3 «Identify» (§77.1) | готово: `GET /api/v1/processes/{id}`, `chronoscope process <id>` и переход из `actor`/`subject` на странице; выпуск версии — отдельным шагом |
