...
| **Chronoscope Core**: приём, нормализация, хранение, API | **готово**, 308 тестов |
...
```powershell
cd core
uv run pytest        # 308 тестов: домен, хранилище, нормализатор, контракт, правила слоёв, приём, индексы, CLI, страница, скрипты, интеграция
