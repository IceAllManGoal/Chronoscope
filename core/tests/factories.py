...
#: Экземпляр notepad.exe, выведенный из host_id + boot_id + pid + времени старта.
PROC_ID = "proc_01M2T1R61M8W1EMS4WBMRDKSTZ"
#: Экземпляр explorer.exe при допущении, что он стартовал в 10:00:00.000Z.
PARENT_PROC_ID = "proc_01M2SZAT80WBG97HT3GY4XRGRK"
